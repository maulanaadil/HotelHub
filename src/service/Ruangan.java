...
public class Ruangan extends javax.swing.JInternalFrame {
    ...
    public void clearComponents() {
        ...
        tf_harga.setText("");
        cb_status_ruangan.setSelectedIndex(0);
        cb_tipe_ruangan.setSelectedIndex(0);
    }
    ...
    public void addDataRuangan() {
        ...
        try {
            ...
            String sql = "INSERT INTO room(id_room, harga, tipe_room, status) VALUES('"+ tf_idruangan.getText()+"', '"+ tf_harga.getText() +"', '"+ cb_tipe_ruangan.getSelectedIndex()+"', '" + cb_status_ruangan.getSelectedIndex()+"')";
    ...
    public void cariData() {
        DefaultTableModel model = new DefaultTableModel();
        String cari = tf_cari_ruangan.getText();
        ...
        try {
            Connection conn = (Connection) Config.configDB();
            Statement state = conn.createStatement();
            String sql = "SELECT * FROM room WHERE tipe_room LIKE'%"+ tf_cari_ruangan.getText() +"%'";
    ...
    public void updateDataRuangan() {
        try {
            String sql = "UPDATE room SET id_room='" + tf_rincian_idruangan.getText() + 
                    "',harga='" + tf_rincian_harga.getText() + 
                    "',tipe_room='" + cb_rincian_tiperuangan.getSelectedItem() + 
                    "',status='" + cb_rincian_status.getSelectedItem()+ 
                    "' WHERE id_room='" + tf_rincian_idruangan.getText() + 
                    "'";
            Connection conn = (Connection)Config.configDB();
    ...
    public void showHint() {
        ...
        tf_cari_ruangan.setUI(new JTextFieldHintUI("Silahkan Masukan Data yang ingin dicari..", Color.GRAY));
    }
    
    public void setVisibleComponents(Boolean b) {
        tf_rincian_idruangan.setVisible(b);
        tf_rincian_harga.setVisible(b);
        cb_rincian_tiperuangan.setVisible(b);
        cb_rincian_status.setVisible(b);
        tv_rincian_data_ruangan.setVisible(b);
        tv_rincian_harga.setVisible(b);
        tv_rincian_id_ruangan.setVisible(b);
        tv_rincian_jk.setVisible(b);
        tv_rincian_status.setVisible(b);
    ...
    private void initComponents() {
        ...
        tf_cari_ruangan = new javax.swing.JTextField();
        ...
        tv_rincian_data_ruangan = new javax.swing.JLabel();
        tv_rincian_id_ruangan = new javax.swing.JLabel();
        tv_rincian_harga = new javax.swing.JLabel();
        tv_rincian_jk = new javax.swing.JLabel();
        tv_rincian_status = new javax.swing.JLabel();
        tf_rincian_harga = new javax.swing.JTextField();
        tf_rincian_idruangan = new javax.swing.JTextField();
        cb_rincian_tiperuangan = new javax.swing.JComboBox<>();
        btn_update = new javax.swing.JButton();
        cb_rincian_status = new javax.swing.JComboBox<>();
        ...
        cb_status_ruangan = new javax.swing.JComboBox<>();
        jLabel13 = new javax.swing.JLabel();
        btn_reset = new javax.swing.JButton();
        btn_submit = new javax.swing.JButton();
        jLabel14 = new javax.swing.JLabel();
        cb_tipe_ruangan = new javax.swing.JComboBox<>();
        ...
        tf_cari_ruangan.setFont(new java.awt.Font("Quicksand SemiBold", 0, 12)); // NOI18N
        tf_cari_ruangan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tf_cari_ruanganKeyPressed(evt);
            }
        });
        ...
        tv_rincian_data_ruangan.setFont(new java.awt.Font("Quicksand SemiBold", 0, 12)); // NOI18N
        tv_rincian_data_ruangan.setText("Rincian Data Ruangan");

        tv_rincian_id_ruangan.setFont(new java.awt.Font("Quicksand SemiBold", 0, 12)); // NOI18N
        tv_rincian_id_ruangan.setText("ID Ruangan");

        tv_rincian_harga.setFont(new java.awt.Font("Quicksand SemiBold", 0, 12)); // NOI18N
        tv_rincian_harga.setText("Harga");

        tv_rincian_jk.setFont(new java.awt.Font("Quicksand SemiBold", 0, 12)); // NOI18N
        tv_rincian_jk.setText("TIpe Ruangan");

        tv_rincian_status.setFont(new java.awt.Font("Quicksand SemiBold", 0, 12)); // NOI18N
        tv_rincian_status.setText("Status");

        tf_rincian_harga.setFont(new java.awt.Font("Quicksand SemiBold", 0, 12)); // NOI18N
        tf_rincian_harga.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tf_rincian_hargaKeyPressed(evt);
            }
        });

        tf_rincian_idruangan.setBackground(new java.awt.Color(234, 246, 248));
        tf_rincian_idruangan.setFont(new java.awt.Font("Quicksand SemiBold", 0, 12)); // NOI18N

        cb_rincian_tiperuangan.setFont(new java.awt.Font("Quicksand Medium", 0, 12)); // NOI18N
        cb_rincian_tiperuangan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "standard", "superior", "deluxe" }));
        ...
        cb_rincian_status.setFont(new java.awt.Font("Quicksand Medium", 0, 12)); // NOI18N
        cb_rincian_status.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "kosong", "terisi" }));
                ...
                .addGroup(panel_data_ruanganLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_data_ruanganLayout.createSequentialGroup()
                        ...
                        .addGroup(panel_data_ruanganLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panel_data_ruanganLayout.createSequentialGroup()
                                .addComponent(tf_cari_ruangan, javax.swing.GroupLayout.PREFERRED_SIZE, 430, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, 0)
                                .addComponent(btn_cari))))
                    .addGroup(panel_data_ruanganLayout.createSequentialGroup()
                        .addGap(42, 42, 42)
                        .addGroup(panel_data_ruanganLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tv_rincian_data_ruangan)
                            .addGroup(panel_data_ruanganLayout.createSequentialGroup()
                                .addGroup(panel_data_ruanganLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(tv_rincian_harga)
                                    .addComponent(tv_rincian_id_ruangan)
                                    .addComponent(tv_rincian_jk)
                                    .addComponent(tv_rincian_status))
                                .addGap(29, 29, 29)
                                .addGroup(panel_data_ruanganLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(tf_rincian_idruangan, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(tf_rincian_harga, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cb_rincian_tiperuangan, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cb_rincian_status, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))))))
        ...
        panel_data_ruanganLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_data_ruanganLayout.createSequentialGroup()
                ...
                .addGroup(panel_data_ruanganLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tf_cari_ruangan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btn_cari))
                .addGap(20, 20, 20)
                ...
                .addGroup(panel_data_ruanganLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tv_rincian_id_ruangan)
                    .addComponent(tf_rincian_idruangan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_data_ruanganLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tv_rincian_harga)
                    .addComponent(tf_rincian_harga, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_data_ruanganLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tv_rincian_jk)
                    .addComponent(cb_rincian_tiperuangan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_data_ruanganLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tv_rincian_status)
                    .addComponent(cb_rincian_status, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        cb_status_ruangan.setFont(new java.awt.Font("Quicksand Medium", 0, 12)); // NOI18N
        cb_status_ruangan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Status Ruangan", "kosong", "terisi" }));
        panel_form_ruangan.add(cb_status_ruangan, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 250, 150, -1));
        ...
        cb_tipe_ruangan.setFont(new java.awt.Font("Quicksand Medium", 0, 12)); // NOI18N
        cb_tipe_ruangan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Tipe Ruangan", "standard", "superior", "deluxe", " " }));
        panel_form_ruangan.add(cb_tipe_ruangan, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 220, 130, -1));
    ...
    private void tb_ruanganMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_ruanganMouseClicked
        ...
        tf_rincian_idruangan.setText(id);
        tf_rincian_idruangan.setEditable(false);

        String harga = tb_ruangan.getValueAt(baris, 1).toString();
        tf_rincian_harga.setText(harga);

        String tipeRuangan = tb_ruangan.getValueAt(baris, 2).toString();
        cb_rincian_tiperuangan.setSelectedItem(tipeRuangan);
        
        String status = tb_ruangan.getValueAt(baris, 3).toString();
        cb_rincian_status.setSelectedItem(status);
        
    }//GEN-LAST:event_tb_ruanganMouseClicked

    private void tf_cari_ruanganKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf_cari_ruanganKeyPressed
        // TODO add your handling code here:
        cariData();
        setVisibleComponents(false);
        if (tf_cari_ruangan.getText() == "") {
            showDataRuangan();
        }
    }//GEN-LAST:event_tf_cari_ruanganKeyPressed
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        if (opsi == JOptionPane.YES_OPTION)  {
            try {
                String sql = "DELETE FROM room WHERE id_room='"+ tf_rincian_idruangan.getText() +"'";
                Connection conn = (Connection)Config.configDB();
                PreparedStatement pstm = conn.prepareStatement(sql);
                pstm.execute();
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        // TODO add your handling code here:
        if (tf_rincian_harga.getText().trim().isEmpty()) {
    ...
    private void btn_submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_submitActionPerformed
        // TODO add your handling code here:
        if (cb_status_ruangan.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(null, "Data Status Ruangan Tidak Boleh Kosong");
        } else
            if (cb_tipe_ruangan.getSelectedIndex() == 0 ) {
    ...
    private void tf_rincian_hargaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf_rincian_hargaKeyPressed
        // TODO add your handling code here:
        char c = evt.getKeyChar();
        if (Character.isLetter(c)) {
            tf_rincian_harga.setEditable(false);
        } else {
            tf_rincian_harga.setEditable(true);
        }
    }//GEN-LAST:event_tf_rincian_hargaKeyPressed
    ...
    private javax.swing.JComboBox<String> cb_rincian_status;
    private javax.swing.JComboBox<String> cb_rincian_tiperuangan;
    private javax.swing.JComboBox<String> cb_status_ruangan;
    private javax.swing.JComboBox<String> cb_tipe_ruangan;
    ...
    private javax.swing.JTextField tf_cari_ruangan;
    private javax.swing.JTextField tf_harga;
    private javax.swing.JTextField tf_idruangan;
    private javax.swing.JTextField tf_rincian_harga;
    private javax.swing.JTextField tf_rincian_idruangan;
    private javax.swing.JLabel tv_rincian_data_ruangan;
    private javax.swing.JLabel tv_rincian_harga;
    private javax.swing.JLabel tv_rincian_id_ruangan;
    private javax.swing.JLabel tv_rincian_jk;
    private javax.swing.JLabel tv_rincian_status;
